...
namespace AUDIO
{
	...
	static void PLAY_SOUND_FRONTEND(int soundId, const char* soundName, const char* setName, BOOL p3) { invoke<Void>(0x67C540AA08E4A6F5, soundId, soundName, setName, p3); } // 0x67C540AA08E4A6F5 0x2E458F74
