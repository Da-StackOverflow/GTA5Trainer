...
//File.Copy("D:\\File\\CPP\\GTA5Trainer\\x64\\Release\\GTA5Trainer.asi", "D:\\App\\Steam\\steamapps\\common\\Grand Theft Auto V\\GTA5Trainer.asi", true);
...
Console.WriteLine("ItemInfo PedModels[] = {");
for (int i = 0; i < a.Count; i++)
{
	Console.WriteLine($"    ItemInfo(\"{b[i]}\", \"{a[i]}\"),");
}
Console.WriteLine("};");
